...
?>
@if(file_exists(\crocodicstudio\crudbooster\CRUDBoosterServiceProvider::getViewsFolder().'/default/type_components/'.$type.'/asset.blade.php'))
...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        $file_location = \crocodicstudio\crudbooster\CRUDBoosterServiceProvider::getViewsFolder().'/default/type_components/'.$type.'/component_detail.blade.php';
